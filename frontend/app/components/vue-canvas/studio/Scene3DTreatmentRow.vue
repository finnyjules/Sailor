...
import { Droplets, Sparkles, Grid3x3, Ghost, Palette, Wind, Grip, Aperture, Tv2, Sun, Square, Scan, Hexagon, Spline, CloudFog, Gem } from 'lucide-vue-next'
...
export const TREATMENT_ICONS: Record<TreatmentKind, Component> = {
  blur: Droplets, glow: Sparkles, pixelate: Grid3x3, fade: Ghost, colorGrade: Palette, dissolve: Wind, halftone: Grip, chromaticSplit: Aperture, glitch: Tv2,
  rimLight: Sun, outline: Square, xray: Scan, wireframe: Hexagon,
  edgeLines: Spline, depthFog: CloudFog, curvatureWear: Gem,
}
</script>
