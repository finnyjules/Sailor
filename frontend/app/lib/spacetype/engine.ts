  ...
  build(params: Params, texOpts: TextTextureOptions): void {
    try {
      ...
      this.root = withShaderFillContext(
        ...
        () => this.effect.buildScene(THREE, params, tex, { width: this.opts.width, height: this.opts.height, axes: texOpts.axes, imageTextures: this.imageTextures, loopDuration: this.opts.loopDuration, fontFamily: texOpts.fontFamily }),
      )
