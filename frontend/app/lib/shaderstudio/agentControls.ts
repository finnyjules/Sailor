...
export const SHADER_LOOK_CLUSTERS: { words: string; ids: string[] }[] = [
  ...
  { words: 'background from nothing / generative field (draws its own field; blend the input with Image mix)', ids: ['aurora', 'nebula', 'plasma', 'mesh_gradient', 'wisps', 'light_beams', 'fbm', 'caustics', 'voronoi_cells', 'starfield', 'warp_tunnel', 'terrain_bands', 'sonar', 'oddgrid', 'mist', 'pixel_bloom', 'thread_contours', 'sear'] },
