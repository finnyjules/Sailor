...
export const SHADER_LOOK_CLUSTERS: { words: string; ids: string[] }[] = [
  ...
  { words: 'BACKGROUND FROM NOTHING (generative — these ignore the input image and draw their own field)', ids: ['aurora', 'nebula', 'plasma', 'mesh_gradient', 'wisps', 'light_beams', 'fbm', 'caustics', 'voronoi_cells', 'starfield', 'warp_tunnel', 'terrain_bands', 'sonar', 'mist', 'pixel_bloom', 'filament', 'sear'] },
