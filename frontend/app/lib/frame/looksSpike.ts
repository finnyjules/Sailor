...
export const SPIKE_LOOKS: SpikeLook[] = [
  ...
  { name:'Statement', bg:'#f2f0ef', layers:()=>[
    t({text:'NOISE',x:0.5,y:0.0967,fontSize:0.2771,fontFamily:'Inter Tight',fontWeight:800,color:'#121212',align:'center',letterSpacing:-0.045,lineHeight:0.86,boxW:0.9318}),
    t({text:'Talks on sound and the city\n12–14 October 2026\nKunsthalle, Hall 2',x:0.2441,y:0.9298,fontSize:0.0339,fontFamily:'Inter Tight',fontWeight:500,color:'#121212',align:'left',letterSpacing:0,lineHeight:1.28,boxW:0.42}),
    t({text:'Free entry · noise.kunsthalle.org',x:0.9498,y:0.5,fontSize:0.0268,fontFamily:'Inter Tight',fontWeight:500,color:'#121212',align:'left',letterSpacing:0.01,lineHeight:1.2,boxW:0.0322})
  ]},
  ...
  { name:'Photo as field', bg:'#f2f0ef', layers:()=>[
    ...
    t({text:'NOISE',x:0.6292,y:0.1327,fontSize:0.4384,fontFamily:'Inter Tight',fontWeight:800,color:'#f2f0ef',align:'left',letterSpacing:-0.045,lineHeight:0.86,boxW:1.1901}),
    t({text:'Talks on sound and the city\n12–14 October 2026\nKunsthalle, Hall 2',x:0.2441,y:0.9298,fontSize:0.0339,fontFamily:'Inter Tight',fontWeight:500,color:'#f2f0ef',align:'left',letterSpacing:0,lineHeight:1.28,boxW:0.42}),
    t({text:'Free entry · noise.kunsthalle.org',x:0.7559,y:0.8951,fontSize:0.0268,fontFamily:'Inter Tight',fontWeight:500,color:'#f2f0ef',align:'right',letterSpacing:0.01,lineHeight:1.2,boxW:0.42})
  ]},
  { name:'Photo as block', bg:'#f2f0ef', layers:()=>[
    img({x:0.262,y:0.5,w:0.4559,h:0.9517}),
    t({text:'NOISE',x:0.9762,y:0.5,fontSize:0.5188,fontFamily:'Inter Tight',fontWeight:800,color:'#121212',align:'left',letterSpacing:-0.045,lineHeight:0.86,boxW:1.4084}),
    t({text:'Free entry · noise.kunsthalle.org',x:0.2441,y:0.9645,fontSize:0.0268,fontFamily:'Inter Tight',fontWeight:500,color:'#121212',align:'left',letterSpacing:0.01,lineHeight:1.2,boxW:0.42}),
    t({text:'Talks on sound and the city\n12–14 October 2026\nKunsthalle, Hall 2',x:0.7379,y:0.0702,fontSize:0.0339,fontFamily:'Inter Tight',fontWeight:500,color:'#121212',align:'left',letterSpacing:0,lineHeight:1.28,boxW:0.4559})
  ]},
  { name:'Split', bg:'#f2f0ef', layers:()=>[
    img({x:0.5,y:0.2364,w:1,h:0.4728}),
    t({text:'NOISE',x:0.709,y:0.4728,fontSize:0.4972,fontFamily:'Inter Tight',fontWeight:800,color:'#dd2200',align:'left',letterSpacing:-0.045,lineHeight:0.86,boxW:1.3497}),
    t({text:'Talks on sound and the city\n12–14 October 2026\nKunsthalle, Hall 2',x:0.2441,y:0.9298,fontSize:0.0339,fontFamily:'Inter Tight',fontWeight:500,color:'#121212',align:'left',letterSpacing:0,lineHeight:1.28,boxW:0.42}),
    t({text:'Free entry · noise.kunsthalle.org',x:0.7559,y:0.9645,fontSize:0.0268,fontFamily:'Inter Tight',fontWeight:500,color:'#121212',align:'right',letterSpacing:0.01,lineHeight:1.2,boxW:0.42})
  ]},
  { name:'Behind', bg:'#f2f0ef', layers:()=>[
    t({text:'NOISE',x:0.8127,y:0.2774,fontSize:0.5643,fontFamily:'Inter Tight',fontWeight:800,color:'#121212',align:'left',letterSpacing:-0.045,lineHeight:0.86,boxW:1.5572}),
    img({x:0.5,y:0.6537,w:1,h:0.6926}),
    t({text:'Talks on sound and the city\n12–14 October 2026\nKunsthalle, Hall 2',x:0.2441,y:0.9298,fontSize:0.0339,fontFamily:'Inter Tight',fontWeight:500,color:'#f2f0ef',align:'left',letterSpacing:0,lineHeight:1.28,boxW:0.42}),
    t({text:'Free entry · noise.kunsthalle.org',x:0.7559,y:0.9645,fontSize:0.0268,fontFamily:'Inter Tight',fontWeight:500,color:'#f2f0ef',align:'right',letterSpacing:0.01,lineHeight:1.2,boxW:0.42})
  ]},
  { name:'Bands', bg:'#f2f0ef', layers:()=>[
    img({x:0.5,y:0.1034,w:1,h:0.2069}),
    t({text:'NOISE',x:0.4955,y:0.2688,fontSize:0.2016,fontFamily:'Inter Tight',fontWeight:800,color:'#dd2200',align:'left',letterSpacing:-0.045,lineHeight:0.86,boxW:0.5471}),
    img({x:0.5,y:0.4368,w:1,h:0.2069}),
    t({text:'NOISE',x:0.4955,y:0.6021,fontSize:0.2016,fontFamily:'Inter Tight',fontWeight:800,color:'#121212',align:'left',letterSpacing:-0.045,lineHeight:0.86,boxW:0.5471}),
    img({x:0.5,y:0.7701,w:1,h:0.2069}),
    t({text:'NOISE',x:0.4955,y:0.9354,fontSize:0.2016,fontFamily:'Inter Tight',fontWeight:800,color:'#dd2200',align:'left',letterSpacing:-0.045,lineHeight:0.86,boxW:0.5471}),
    t({text:'Talks on sound and the city\n12–14 October 2026\nKunsthalle, Hall 2',x:0.2441,y:0.0702,fontSize:0.0339,fontFamily:'Inter Tight',fontWeight:500,color:'#f2f0ef',align:'left',letterSpacing:0,lineHeight:1.28,boxW:0.42}),
    t({text:'Free entry · noise.kunsthalle.org',x:0.7559,y:0.0355,fontSize:0.0268,fontFamily:'Inter Tight',fontWeight:500,color:'#f2f0ef',align:'right',letterSpacing:0.01,lineHeight:1.2,boxW:0.42})
  ]},
  { name:'Circle photo', bg:'#f2f0ef', layers:()=>[
    img({x:0.525,y:0.7369,w:1.0268,h:0.7268}),
    t({text:'NOISE',x:0.5774,y:0.8476,fontSize:0.3938,fontFamily:'Inter Tight',fontWeight:800,color:'#121212',align:'left',letterSpacing:-0.045,lineHeight:0.86,boxW:1.0866}),
    t({text:'Talks on sound and the city\n12–14 October 2026\nKunsthalle, Hall 2',x:0.2441,y:0.0702,fontSize:0.0339,fontFamily:'Inter Tight',fontWeight:500,color:'#121212',align:'left',letterSpacing:0,lineHeight:1.28,boxW:0.42}),
    t({text:'Free entry · noise.kunsthalle.org',x:0.7559,y:0.0355,fontSize:0.0268,fontFamily:'Inter Tight',fontWeight:500,color:'#121212',align:'right',letterSpacing:0.01,lineHeight:1.2,boxW:0.42})
  ]},
  { name:'Perimeter photo', bg:'#f2f0ef', layers:()=>[
    img({x:0.5,y:0.5,w:1,h:1}),
    t({text:'Talks on sound and the city',x:0.5,y:0.0382,fontSize:0.0311,fontFamily:'Inter Tight',fontWeight:500,color:'#f2f0ef',align:'left',letterSpacing:0,lineHeight:1.28,boxW:0.9318}),
    t({text:'12–14 October 2026',x:0.946,y:0.5,fontSize:0.0311,fontFamily:'Inter Tight',fontWeight:500,color:'#f2f0ef',align:'left',letterSpacing:0,lineHeight:1.28,boxW:0.0398}),
    t({text:'Kunsthalle, Hall 2',x:0.5,y:0.9618,fontSize:0.0311,fontFamily:'Inter Tight',fontWeight:500,color:'#f2f0ef',align:'left',letterSpacing:0,lineHeight:1.28,boxW:0.9318}),
    t({text:'Free entry · noise.kunsthalle.org',x:0.054,y:0.5,fontSize:0.0311,fontFamily:'Inter Tight',fontWeight:500,color:'#f2f0ef',align:'left',letterSpacing:0,lineHeight:1.28,boxW:0.0398}),
    t({text:'NOISE',x:0.4694,y:0.8532,fontSize:0.2758,fontFamily:'Inter Tight',fontWeight:800,color:'#f2f0ef',align:'left',letterSpacing:-0.045,lineHeight:0.86,boxW:0.7612})
  ]},
  { name:'Slices', bg:'#f2f0ef', layers:()=>[
    img({x:0.5,y:0.168,w:1,h:0.336}),
    img({x:0.5,y:0.5013,w:1,h:0.336}),
    img({x:0.5,y:0.8347,w:1,h:0.336}),
    t({text:'NOISE',x:0.6113,y:0.3851,fontSize:0.4184,fontFamily:'Inter Tight',fontWeight:800,color:'#f2f0ef',align:'left',letterSpacing:-0.045,lineHeight:0.86,boxW:1.1544}),
    t({text:'Talks on sound and the city\n12–14 October 2026\nKunsthalle, Hall 2',x:0.2441,y:0.0702,fontSize:0.0339,fontFamily:'Inter Tight',fontWeight:500,color:'#f2f0ef',align:'left',letterSpacing:0,lineHeight:1.28,boxW:0.42}),
    t({text:'Free entry · noise.kunsthalle.org',x:0.7559,y:0.9645,fontSize:0.0268,fontFamily:'Inter Tight',fontWeight:500,color:'#f2f0ef',align:'right',letterSpacing:0.01,lineHeight:1.2,boxW:0.42})
  ]},
  { name:'Counter-form', bg:'#f2f0ef', layers:()=>[
    r({x:0.4163,y:0.4864,w:0.9756,h:0.6905,fill:'#dd2200'}),
    t({text:'NOISE',x:0.4843,y:0.2838,fontSize:0.3317,fontFamily:'Inter Tight',fontWeight:800,color:'#f2f0ef',align:'left',letterSpacing:-0.045,lineHeight:0.86,boxW:0.9004}),
    t({text:'Talks on sound and the city\n12–14 October 2026\nKunsthalle, Hall 2',x:0.2441,y:0.9298,fontSize:0.0339,fontFamily:'Inter Tight',fontWeight:500,color:'#121212',align:'left',letterSpacing:0,lineHeight:1.28,boxW:0.42}),
    t({text:'Free entry · noise.kunsthalle.org',x:0.7559,y:0.9645,fontSize:0.0268,fontFamily:'Inter Tight',fontWeight:500,color:'#121212',align:'right',letterSpacing:0.01,lineHeight:1.2,boxW:0.42})
  ]},
  { name:'Knockout', bg:'#f2f0ef', layers:()=>[
    r({x:0.5,y:0.5946,w:1,h:0.655,fill:'#121212'}),
    t({text:'NOISE',x:0.5507,y:0.5945,fontSize:0.3806,fontFamily:'Inter Tight',fontWeight:800,color:'#f2f0ef',align:'left',letterSpacing:-0.045,lineHeight:0.86,boxW:1.0332}),
    t({text:'Talks on sound and the city\n12–14 October 2026\nKunsthalle, Hall 2',x:0.2441,y:0.0702,fontSize:0.0339,fontFamily:'Inter Tight',fontWeight:500,color:'#121212',align:'left',letterSpacing:0,lineHeight:1.28,boxW:0.42}),
    t({text:'Free entry · noise.kunsthalle.org',x:0.7559,y:0.9645,fontSize:0.0268,fontFamily:'Inter Tight',fontWeight:500,color:'#121212',align:'right',letterSpacing:0.01,lineHeight:1.2,boxW:0.42})
  ]},
  { name:'Bleed circle', bg:'#f2f0ef', layers:()=>[
    r({x:0.0941,y:0.8425,w:1.7696,h:1.2525,fill:'#dd2200'}),
    t({text:'NOISE',x:0.7343,y:0.0744,fontSize:0.1652,fontFamily:'Inter Tight',fontWeight:800,color:'#121212',align:'left',letterSpacing:-0.045,lineHeight:0.86,boxW:0.4484}),
    t({text:'Talks on sound and the city\n12–14 October 2026\nKunsthalle, Hall 2',x:0.2441,y:0.9298,fontSize:0.0339,fontFamily:'Inter Tight',fontWeight:500,color:'#f2f0ef',align:'left',letterSpacing:0,lineHeight:1.28,boxW:0.42}),
    t({text:'Free entry · noise.kunsthalle.org',x:0.7559,y:0.9645,fontSize:0.0268,fontFamily:'Inter Tight',fontWeight:500,color:'#121212',align:'right',letterSpacing:0.01,lineHeight:1.2,boxW:0.42})
  ]},
  { name:'Badge', bg:'#f2f0ef', layers:()=>[
    t({text:'NOISE',x:0.5964,y:0.67,fontSize:0.4076,fontFamily:'Inter Tight',fontWeight:800,color:'#121212',align:'left',letterSpacing:-0.045,lineHeight:0.86,boxW:1.1246}),
    e({x:0.1425,y:0.8135,w:0.3328,h:0.2355,fill:'#dd2200'}),
    t({text:'12–14\nOctober\n2026',x:0.1425,y:0.8135,fontSize:0.0668,fontFamily:'Inter Tight',fontWeight:800,color:'#f2f0ef',align:'center',letterSpacing:-0.045,lineHeight:0.86,boxW:0.3435}),
    t({text:'Talks on sound and the city\nKunsthalle, Hall 2',x:0.2441,y:0.0548,fontSize:0.0339,fontFamily:'Inter Tight',fontWeight:500,color:'#121212',align:'left',letterSpacing:0,lineHeight:1.28,boxW:0.42}),
    t({text:'Free entry · noise.kunsthalle.org',x:0.7559,y:0.0355,fontSize:0.0268,fontFamily:'Inter Tight',fontWeight:500,color:'#121212',align:'right',letterSpacing:0.01,lineHeight:1.2,boxW:0.42})
  ]}
]
